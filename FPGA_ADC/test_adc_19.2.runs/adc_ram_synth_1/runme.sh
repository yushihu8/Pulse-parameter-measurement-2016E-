...
HD_PWD='C:/FPGA_project/xc7z020clg484-1/test_adc_19.2/test_adc_19.2.runs/adc_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adc_ram.tcl
