...
HD_PWD='C:/FPGA_project/xc7z020clg484-1/test_adc_19.2/test_adc_19.2.runs/clk_wiz_40_96m_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_40_96m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_40_96m.tcl
